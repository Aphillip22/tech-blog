...
async function editFormHandler(event) {
    ...
    // Get the user name, id, email, and password from form
    ...
    if (!password.length) {
        alert('Please enter your current password to confirm changes or create a new password.');
        return
    } else {
    ...
    // Create a string with updates provided
